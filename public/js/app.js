$(document).ready(function () {
    ...
    $('.navbar .navbar-nav .dropdown-list .dropdown-content > li').on(
        'touchstart',
        function (e) {
            e.stopPropagation();
            e.preventDefault();
    ...
    $(
        '.navbar .navbar-nav .dropdown-list .dropdown-content .dropdown-content-list > li',
    ...
    $('.navbar-nav .dropdown-list .dropdown-content li').on(
